...
axes.axvline(x = charge_time, ymin = y_limits[0], ymax = volt_max / y_limits[1], color = 'black', linestyle = 'dashed')
axes.axhline(y = volt_max, xmin = x_limits[0], xmax = charge_time / x_limits[1], color = 'black', linestyle = 'dashed')

axes.scatter(time_arr[volt_max_ind], volt_max, color = 'black')

axes.scatter(x = charge_time, y = 0.0, color = 'black')
axes.text(x = charge_time + 0.1, y = 0.05, s = str(round(charge_time, 2)), fontsize = 12)

axes.scatter(x = 0.0, y = volt_max, color = 'black')
